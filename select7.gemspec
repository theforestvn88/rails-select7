...
Gem::Specification.new do |spec|
  ...
  spec.summary     = "similar to select2, but no jquery, only for rails7 (+ stimulus.js)"
  spec.description = "similar to select2, but no jquery, only for rails7 (+ stimulus.js)"
    spec.license     = "MIT"
